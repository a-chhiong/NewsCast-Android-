...
public class LoveListAdapter extends MyBaseAdapter<RssData>
{
    private LocalBroadcastManager broadcastManager;

    public LoveListAdapter(Context context, ArrayList<RssData> list)
    {
        super(context, list);
    ...
    public View getView(final int position, View convertView, ViewGroup parent)
    {
        ...
        if(view == null)
        {
            view = inflater.inflate(R.layout.adapter_love_list, null);
        }
        ...
        final ImageView iv_remove = view.findViewById(R.id.iv_remove_love_list_adapter);
        ...
        LinearLayout ll_core = view.findViewById(R.id.ll_core_love_list_adapter);

        TextView tv_title = view.findViewById(R.id.tv_title_love_list_adapter);
        tv_title.setText(data.getTitle());

        TextView tv_parent = view.findViewById(R.id.tv_parent_love_list_adapter);
        tv_parent.setText(data.getParent());

        TextView tv_category = view.findViewById(R.id.tv_category_love_list_adapter);
        tv_category.setText(data.getCategory());

        TextView tv_pubdate = view.findViewById(R.id.tv_pubdate_love_list_adapter);
        tv_pubdate.setText(data.getPubdate());

        ImageView iv_arrow = view.findViewById(R.id.iv_arrow_love_list_adapter);
