...
public class ItemListAdapter extends MyBaseAdapter<RssData> {

    private LocalBroadcastManager broadcastManager;

    public ItemListAdapter(Context context, ArrayList<RssData> list)
    {
        super(context, list);
    ...
    public View getView(final int position, View convertView, ViewGroup parent)
    {
        ...
        final ImageView iv_mark = view.findViewById(R.id.iv_mark_item_list_adapter);
        ...
        LinearLayout ll_core = view.findViewById(R.id.ll_core_item_list_adapter);

        TextView tv_title = view.findViewById(R.id.tv_title_item_list_adapter);
        tv_title.setText(data.getTitle());

        TextView tv_parent = view.findViewById(R.id.tv_parent_item_list_adapter);
        tv_parent.setText(data.getParent());

        TextView tv_category = view.findViewById(R.id.tv_category_item_list_adapter);
        tv_category.setText(data.getCategory());

        TextView tv_pubdate = view.findViewById(R.id.tv_pubdate_item_list_adapter);
        tv_pubdate.setText(data.getPubdate());

        ImageView iv_arrow = view.findViewById(R.id.iv_arrow_item_list_adapter);
