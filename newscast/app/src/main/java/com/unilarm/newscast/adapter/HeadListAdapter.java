...
public class HeadListAdapter extends MyBaseAdapter<RssData> {

    private LocalBroadcastManager broadcastManager;

    public HeadListAdapter(Context context, ArrayList<RssData> list)
    {
        super(context, list);
    ...
    public View getView(final int position, View convertView, ViewGroup parent)
    {
        ...
        if(view == null)
        {
            view = inflater.inflate(R.layout.adapter_head_list, null);
        }
        ...
        final ImageView iv_remove = view.findViewById(R.id.iv_remove_head_list_adapter);
        ...
        LinearLayout ll_core = view.findViewById(R.id.ll_core_head_list_adapter);

        TextView tv_title = view.findViewById(R.id.tv_title_head_list_adapter);
        tv_title.setText(data.getTitle());

        TextView tv_description = view.findViewById(R.id.tv_description_head_list_adapter);
        tv_description.setText(data.getDescription());

        TextView tv_pubdate = view.findViewById(R.id.tv_pubdate_head_list_adapter);
        tv_pubdate.setText(data.getPubdate());

        ImageView iv_arrow = view.findViewById(R.id.iv_arrow_head_list_adapter);
        ...
        ll_core.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                ...
                if(data.getMark() == null || !data.getMark().equals(DaoHandle.SET))
                {
                    boolean tick = data.isTick();
    ...
    protected void markClick(RssData data, int index)
    {
        ...
        Intent intent = new Intent("ChanListActivity"); //always goes to ...
